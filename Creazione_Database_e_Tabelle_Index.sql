...
/*Creazione tabella PRODOTTO, indicizzata*/
...
/*Creazione tabella ORDINE, indicizzata*/
...
(
  ...
  INDEX `IdProdotto` 	(`IdProdotto` ASC) ,
  INDEX `IdUtente` 		(`IdUtente` ASC) ,
  INDEX `IdPagamento` 	(`IdPagamento` ASC) ,
  INDEX `IdSpedizione` 	(`IdSpedizione` ASC) ,
